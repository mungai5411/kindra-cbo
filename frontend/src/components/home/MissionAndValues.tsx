...
export const MissionAndValues: React.FC = () => {
  ...
  return (
    <Box
      sx={{
        py: { xs: 6, md: 10 },
        background: `linear-gradient(180deg, ${alpha(colorPsychology.programs.cases.primary, 0.02)} 0%, ${alpha(colorPsychology.programs.donations.primary, 0.02)} 100%)`,
        position: 'relative',
        overflow: 'hidden'
      }}
    >
        ...
        <Grid container spacing={{ xs: 4, md: 6 }} alignItems="center">
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              >
                Driven by <Box component="span" sx={{ color: colorPsychology.programs.volunteers.primary }}>Purpose</Box>, Guided by <Box component="span" sx={{ color: colorPsychology.programs.donations.primary }}>Values</Box>
              </Typography>
            ...
            >
              ...
              <Box
                sx={{
                  ...
                  right: 0,
                  bottom: 0,
                  background: `linear-gradient(135deg, ${colorPsychology.programs.volunteers.primary} 0%, ${colorPsychology.programs.shelter.primary} 100%)`,
                  borderRadius: 3,
                  opacity: 0.04,
                  zIndex: 0
                }}
              ...
              <Box
                sx={{
                  position: 'absolute',
                  inset: 0,
                  background: `linear-gradient(180deg, ${alpha(colorPsychology.programs.cases.primary, 0.1)}, ${alpha(colorPsychology.programs.donations.primary, 0.08)})`,
                  border: `1px solid ${alpha(colorPsychology.programs.cases.primary, 0.2)}`,
                  borderRadius: 3,
                  p: { xs: 3, md: 4 },
                  display: 'flex',
              ...
              >
                <Box sx={{ mb: 3 }}>
                  ...
                  <Box sx={{
                    ...
                    px: 2,
                    py: 1,
                    bgcolor: alpha(colorPsychology.programs.donations.primary, 0.15),
                    borderRadius: 2,
                    mb: 2
                  }}>
                    <Typography variant="caption" sx={{ fontWeight: 700, color: colorPsychology.programs.donations.primary }}>
                      ✓ REGISTERED & VERIFIED
                    </Typography>
                  </Box>
                </Box>
                ...
                <Stack spacing={2}>
                  {[
                    ...
                    <Typography key={i} variant="body2" sx={{ fontWeight: 600, fontSize: '0.95rem' }}>
                      {stat}
                    </Typography>
                  ))}
                </Stack>

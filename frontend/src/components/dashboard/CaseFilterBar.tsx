 ...
 * Allows real-time filtering with visual feedback
 */
...
interface CaseFilterBarProps {
  ...
  urgentCount?: number;
  overdueCount?: number;
  savedFilters?: Array<{ name: string; filters: Record<string, string[]> }>;
}
  ...
  return (
    <Box sx={{ mb: 3 }}>
      ...
      <Box sx={{
        ...
        {/* Search Input */}
        <TextField
          placeholder="Search by name, case#, family..."
          value={searchQuery}
      ...
      <Box sx={{
        ...
        <Typography variant="body2" sx={{ fontWeight: 600, color: 'text.primary' }}>
          Showing <strong>{filteredResults}</strong> of <strong>{totalResults}</strong> cases
        </Typography>

/**
 * Donation Filter Bar Component
 * Advanced filtering for donations/campaigns
 */
...
export const DonationFilterBar: React.FC<DonationFilterBarProps> = ({
  onFilterChange,
  onSearch,
  filterGroups,
  totalResults,
  ...
  return (
    <Box sx={{ mb: 3 }}>
      ...
      <Box sx={{
        ...
        {/* Search Input */}
        <TextField
          placeholder="Search by campaign, donor, amount..."
          value={searchQuery}
